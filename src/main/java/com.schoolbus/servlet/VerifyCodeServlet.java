package com.schoolbus.servlet;

/**
 * Created by t on 2016/12/4.
 */
 ...
 *
 */
@WebServlet(urlPatterns = "/code",description = "生成验证码")
...
//        this.getServletContext().setAttribute("validateCode", validateCode);
//        request.getRequestDispatcher("/create").forword(request,response);
        // 禁止图像缓存。
